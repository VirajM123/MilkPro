...
// Prevent this screen from reloading twice when it broadcasts
// its own successful product save/update/delete.
bool _ignoreNextProductSyncEvent = false;
...
void _onDataSyncChanged() {
  ...
  // Ignore the event generated by this screen itself.
  // Other screens still receive the same notification.
  if (_ignoreNextProductSyncEvent &&
      event == SyncEventType.products) {
    _ignoreNextProductSyncEvent = false;
    return;
  }
...
Future<void> _loadProductsSilent() async {
  ...
  try {
    ...
    debugPrint(
      'Product silent sync error: $error',
    );
  }
}

void _notifyProductChanged() {
  _ignoreNextProductSyncEvent = true;
      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                '${_formatQuantity(product.stock)} ${product.unit}',
                style: const TextStyle(
                  color: AppColors.textPrimary,
